...
export default function App() { // Este es nuestro functional component llamado App, es una simple función de JavaScript,
    ...
    const items = [{
        text: "Crafting Kit", imagePath: require("./assets/crafting_kit_elden_ring_wiki_guide_200px.png")
    }, {
        text: "Dark Moon Greatsword", imagePath: {
    ...
    return (<ScrollView>
        ...
        {/*
        Podemos usar arreglos para pintar elementos de forma dinámica, con map por ejemplo, pero, tenemos que usar un
        id en los componentes, llamado key
        */
...
const styles = StyleSheet.create({
    container: {
        flex: 1, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', marginTop: 100
    }, text: {
