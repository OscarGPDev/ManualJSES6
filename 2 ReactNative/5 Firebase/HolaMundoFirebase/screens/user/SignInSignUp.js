...
const SignInSignUp = ({setUser}) => {
    ...
    const isSignUp = () => setUserLoginData({...userLoginData, signUp: !userLoginData.signUp});
    const signUpActionButtonText = !userLoginData.signUp ? "Iniciar sesión" : "Registrarse";
                ...
                <View
                    ...
                    <Section title="Inicia sesión para continuar">
                        <View style={{flexDirection: "column"}}>
                                       ...
                                       defaultValue={userLoginData.password}/>
                            {
                                userLoginData.signUp && <>
                                    ...
                                    <TextInput textContentType="name"
                                               onChangeText={newText => setUserLoginData({
                                                   ...userLoginData,
                                                   nombre: {...userLoginData.nombre, apellidoPaterno: newText}
                                               })}
                                    ...
                                    <TextInput textContentType="name"
                                               onChangeText={newText => setUserLoginData({
                                                   ...userLoginData,
                                                   nombre: {...userLoginData.nombre, apellidoMaterno: newText}
                                               })}
                            ...
                            <Button title={signUpActionButtonText} onPress={signInUpActionFunction}></Button>
                            <Button title={signUpActionText} onPress={isSignUp}></Button>
                        </View>
